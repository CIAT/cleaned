...
biomass_calculation <- function(para, land_required){
  ...
  # Tier 1 and 3 are not incorporated in the latest model
  ...
  for (f in feeds){
    ...
    trees_non_feed_biomass[[f]] <- selected_feed_production %>%
      ...
      mutate(area_ha = sum(selected_land_required$farm),
             ...
             dbh_25_yearN = ifelse(is.na((years*increase_dbh25)+dbh_25_year0), 0, (years*increase_dbh25)+dbh_25_year0),
             ...
             dbh_2550_yearN = ifelse(is.na((years*increase_dbh2550)+dbh_2550_year0), 0, (years*increase_dbh2550)+dbh_2550_year0),
             ...
             dbh_50_yearN = ifelse(is.na((years*increase_dbh50)+dbh_50_year0), 0, (years*increase_dbh50)+dbh_50_year0),
