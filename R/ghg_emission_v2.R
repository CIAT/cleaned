...
#'
#' @param ym_prod Logical. Should milk yield be used in assignment of ym to dairy cattle? Default = F
#'
#' @return list
#'
...
ghg_emission <- function(para, energy_required, ghg_ipcc_data, land_required, nitrogen_balance,feed_basket_quality,ym_prod=F){
  ...
  if(ym_prod==T){
    productivity1 <-  ym1%>%
      mutate(productivity=ifelse(ipcc_meth_man_category == "Dairy cows" & (annual_milk > 8500|annual_milk==0) & de >= 0.7,"High  productivity systems",
                                 ifelse(ipcc_meth_man_category == "Dairy cows"& (annual_milk %gle% c(5000,8500)|annual_milk==0) & de %gel% c(0.63,0.7),"High  productivity systems",
                                        ifelse(ipcc_meth_man_category == "Dairy cows"& (annual_milk <= 5000|annual_milk==0) & de <= 0.62,"Low  productivity systems",
                                               ifelse(ipcc_meth_man_category == "Other cattle" & de < 0.63,"Low  productivity systems",
    ...
    productivity1 <-  ym1%>%
      mutate(productivity=ifelse(ipcc_meth_man_category == "Dairy cows" & de >= 0.7,"High  productivity systems",
                                 ifelse(ipcc_meth_man_category == "Dairy cows" & de %gel% c(0.63,0.7),"High  productivity systems",
                                        ifelse(ipcc_meth_man_category == "Dairy cows" & de <= 0.62,"Low  productivity systems",
                                               ifelse(ipcc_meth_man_category == "Other cattle" & de < 0.63,"Low  productivity systems",
                                                      ifelse(ipcc_meth_man_category == "Other cattle" & de < 0.72 & de > 0.62,"Low  productivity systems",
                                                             ifelse(ipcc_meth_man_category == "Other cattle" & de >= 0.72 & de < 0.75,"High  productivity systems",
                                                                    ifelse(ipcc_meth_man_category == "Other cattle" & de >= 0.75,"High  productivity systems",
