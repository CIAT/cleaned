...
manure_tot<-(numcow_is*mprod_is+numcow_sis*mprod_sis+numcow_es*mprod_es)*365
mprod_g<- (numcow_is*mprod_is+numcow_sis*mprod_sis+numcow_es*mprod_es)*mms_pasture_perc/100*365
mprod_c<- (numcow_is*mprod_is+numcow_sis*mprod_sis+numcow_es*mprod_es)*mms_lagoon_perc/100*365+
  (numcow_is*mprod_is+numcow_sis*mprod_sis+numcow_es*mprod_es)*mms_liquidslurry_perc/100*365+
  (numcow_is*mprod_is+numcow_sis*mprod_sis+numcow_es*mprod_es)*mms_solidstorage_perc/100*365+
  (numcow_is*mprod_is+numcow_sis*mprod_sis+numcow_es*mprod_es)*mms_drylot_perc/100*365+
  (numcow_is*mprod_is+numcow_sis*mprod_sis+numcow_es*mprod_es)*mms_dailyspread_perc/100*365
#slurry production  
slprod_c<-(numcow_is*mprod_is+numcow_sis*mprod_sis+numcow_es*mprod_es)*mms_digester_perc/100*365
...
fun<-function(x,y,z,a,b){(x+y+z)*(-9.4+(0.13*a)+(0.01*b))}
G<-overlay (Nsoil,Ni_c,Ni_g,CLavg,rain,fun=fun)
#plot(G)
